...
# %%
# multiply avg_sale_rate * sum 
df_f['home_product_purchase'] = df_f.apply(lambda x : x['avg_sales_rate'] * x['sum'] ,  axis=1)
...
# %%
subject = "TEST (HMBR-06) H_63_SALES & PURCHASE CASH ANALYSIS PLANNING"
