...
# %%
df = get_sales(100005, '2023-01-01')
df_cus = get_cacus(100005)
...
# %%
df_main.to_excel('customer_wise_monthly_sales.xlsx' , engine= 'openpyxl')
...
subject = 'Monthly sales report Customer wise'
body = 'Please find attached the monthly sales report by customer'
filename = 'customer_wise_monthly_sales.xlsx'
